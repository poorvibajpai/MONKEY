  ...
  return (
    <div className="mx-auto max-w-7xl px-4 md:px-8 2xl:px-16">
      ...
      <div className="flex items-start">
        ...
        <div className="ml-6">
          <p className="flex items-baseline">
            <span className="text-gray-600 font-bold">Poorvi Bajpai</span>
      ...
      <div className="flex items-start">
        ...
        <div className="ml-6">
          <p className="flex items-baseline">
            <span className="text-gray-600 font-bold">Anamika Singh</span>
            <span className="ml-2 text-green-600 text-xs">Verified Buyer</span>
          </p>
          <div className="flex items-center mt-1">
            <svg
      ...
      <div className="flex items-start">
        ...
        <div className="ml-6">
          <p className="flex items-baseline">
            <span className="text-gray-600 font-bold">Anaya Pandey</span>
            <span className="ml-2 text-green-600 text-xs">Verified Buyer</span>
          </p>
          <div className="flex items-center mt-1">
            <svg
      ...
      <div className="flex items-start">
        ...
        <div className="ml-6">
          <p className="flex items-baseline">
            <span className="text-gray-600 font-bold">Shivam Singh</span>
            <span className="ml-2 text-green-600 text-xs">Verified Buyer</span>
          </p>
          <div className="flex items-center mt-1">
            <svg
