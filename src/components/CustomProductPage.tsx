...
// const customImg = "https://mockey.s3.fr-par.scw.cloud/thumbnails/model-204-thumb.png";
...
//     function drawImage(withHandles = showHandles) {
//       setCanvasBackground(); // Set the background color and redraw the background image
//       ctx.drawImage(img, imgX, imgY, imgWidth, imgHeight); // Draw the image on canvas
//       if (withHandles) {
//        drawHandles();
//       }
//      }

//      function drawHandles(show = true) {
//       if (!show) return;
...
//      imageUpload.addEventListener("change", function (event:any) {
...
//         imgWidth = 150;
//         imgHeight = 150;
//         drawImage(); // Draw the image on canvas
//        };
...
//     //   link.click();
//     //   drawImage(); // Redraw image with handles
//     //  });
//   }, [selectedColor]);
...
//         {/* <button id='prevBtn' onClick={() => setPrev(!prev)} className='absolute top-5 right-8 z-10 bg-white/85 flex items-center p-2 gap-2'><span>Preview</span> {prev ? <Eye width={20} height={20}/> :<EyeOff width={20} height={20}/>} </button> */}
//         <button id='prevBtn' onClick={() => setPrev(!prev)} className='absolute top-5 right-8 z-10 bg-white/85 flex items-center p-2 gap-2'>Preview </button>
//           <canvas id='canvas' className='border-2' width={550} height={700}>
//           </canvas>
//         </div>
//       </section>
//       <br></br>
...
import { useEffect, useState } from 'react';
import { ColorResult, SketchPicker } from 'react-color';
import customImg from "../assets/model.png"
const galleryImg = "https://mockey.ai/assets/image-add-black.60f3b7ff.svg";
const colorImg = "https://mockey.ai//assets/color.837f7442.svg";
// const customImg = "https://mockey.s3.fr-par.scw.cloud/thumbnails/model-204-thumb.png";
